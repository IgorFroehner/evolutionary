...
fn main() {
    ...
    let evolution_builder = EvolutionBuilder::new(50, 500, GeneCod::Real, (0.0, 1.0))
    ...
    let mut experiment = ExperimentRunner::new("Maze 2 - Caminho Minimo".to_string(), 30, evolution_builder);
